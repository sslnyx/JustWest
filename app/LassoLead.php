...
class LassoLead extends Model
{
    ...
    // public function addRegistrationDate($date)
    // {
    //     $this->registrationDate = (object) array(
    //         'date' => "2019-12-12 10:49:48.899263"
    //     );
    // }
    ...
    // public function setLassoUid($lassoUid)
    // {
    //     $this->lassoUid = $lassoUid;
    // }
    /**
     ...
     */
    public function addEmail($email, $type = 'Primary', $primary = true)
    {
        $this->emails[] = [
            'email' => $email,
            'type' => $type,
     ...
     * @param Boolean $primary
     */
    public function addPhone($phone, $type = 'Work', $primary = true)
    {
        $this->phones[] = [
            'phone' => $phone,
            'type' => $type,
